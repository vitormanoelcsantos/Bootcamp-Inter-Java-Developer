package one.innovation.digital.wesleyfuchter.stream;

import one.innovation.digital.wesleyfuchter.comparators.desafio.EstadoOrdenadoNome;
...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        // Adiciona 8 estudantes para a coleção
        ...
        estudantes.add("Maria Eduarda");
        estudantes.add("Maria Soares");
        ...
        System.out.println("Não tem nenhum elemento com letra minúscula no nome? " + estudantes.stream().noneMatch((elemento) -> elemento.contains("a")));
